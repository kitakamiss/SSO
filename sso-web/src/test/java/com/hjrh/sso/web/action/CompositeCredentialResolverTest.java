...
import com.hjrh.sso.web.action.CompositeCredentialResolver;
...
public class CompositeCredentialResolverTest {
	...
	public void testResolveCredentialWithAbstractParameter(){
		...
		request.getSession().setAttribute(WebConstants.sso_SERVICE_KEY_IN_SESSION, "http://localhost/test.htm");
